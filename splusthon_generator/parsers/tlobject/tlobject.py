...
# https://github.com/telegramdesktop/tdesktop/blob/4bf66cb6e93f3965b40084771b595e93d0b11bcd/SoroushPlus/SourceFiles/codegen/scheme/codegen_scheme.py#L57-L62
WHITELISTED_MISMATCHING_IDS = {
    ...
    0: {'channel',  # Since layer 77, there seems to be no going back...
        ...
        # Soroush-specific types (IDs from Soroush server schema)
        'userTypeMxb', 'channelFullCustom', 'participantLocation',
        'inputMediaPayment', 'messageMediaPayment',
        'genderFemale', 'genderMale',
        'inputPrivacyKeyGender', 'privacyKeyGender',
        'inputPrivacyKeySavedMusic', 'privacyKeySavedMusic',
        'thirdParty.message', 'thirdParty.reply',
        'users.savedMusicNotModified', 'users.savedMusic',
        'account.savedMusicIdsNotModified', 'account.savedMusicIds',
        'profileTabPosts', 'profileTabGifts', 'profileTabMedia',
        'profileTabFiles', 'profileTabMusic', 'profileTabVoice',
        'profileTabLinks', 'profileTabGifs',
        'userFullCustom',
        'messages.chatFull', 'users.userFull',
        'config',
        'account.updateGender', 'channels.toggleMembershipMessageVisibility',
        'account.saveMusic', 'account.setMainProfileTab',
        'account.getSavedMusicIds', 'account.updatePersonalChannel',
        'users.getSavedMusic', 'users.getSavedMusicByID',
        'messages.toggleDialogFilterTags',
        'thirdParty.request', 'thirdParty.tell',
        'auth.sentDeleteAccountCode', 'chatInviteExported'}
}
