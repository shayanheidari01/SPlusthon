...
def get_import_code(tlobject):
    ...
    return 'from splusthon.tl.{}{} import {}'\
            ...
            if tlobject.is_function:
                ...
                if tlobject.friendly:
                    ...
                    docs.write_text(
                        ...
                        'https://docs.splusthon.dev/en/stable/modules/client.html'
                        '#splusthon.client.{0}.{1}"><code>client.{1}()</code></a> '
                ...
                docs.write('''<pre>\
<strong>from</strong> splusthon.sync <strong>import</strong> SoroushClient
<strong>from</strong> splusthon <strong>import</strong> functions, types
