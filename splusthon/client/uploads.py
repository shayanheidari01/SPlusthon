...
class UploadMethods:
    ...
    async def send_file(
        ...
        Arguments
            ...
            file (`str` | `bytes` | `file` | `media`):
                ...
                * A Bot API-like ``file_id``. You can convert previously
                  ...
                  `splusthon.utils.pack_bot_file_id`.
            ...
            reply_to (`int` | `Message <splusthon.tl.custom.message.Message>`):
        ...
        Returns
            The `Message <splusthon.tl.custom.message.Message>` (or messages)
    ...
    async def upload_file(
        ...
        Returns
            ...
            `InputSizedFile <splusthon.tl.custom.inputsizedfile.InputSizedFile>`
