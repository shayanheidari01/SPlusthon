...
class DialogMethods:
    ...
    def iter_dialogs(
        ...
        Yields
            Instances of `Dialog <splusthon.tl.custom.dialog.Dialog>`.
    ...
    def iter_drafts(
        ...
        Yields
            Instances of `Draft <splusthon.tl.custom.draft.Draft>`.
    ...
    async def delete_dialog(
        ...
        See also `Dialog.delete() <splusthon.tl.custom.dialog.Dialog.delete>`.
    ...
    def conversation(
        ...
        """
        Creates a `Conversation <splusthon.tl.custom.conversation.Conversation>`
        ...
        Arguments
            ...
            replies_are_responses (`bool`, optional):
                ...
                <splusthon.tl.custom.conversation.Conversation.get_response>`
                and a subsequent call to `conv.get_reply
                <splusthon.tl.custom.conversation.Conversation.get_reply>`
        ...
        Returns
            A `Conversation <splusthon.tl.custom.conversation.Conversation>`.
