...
class TelegramBaseClient(abc.ABC):
    ...
    Arguments
        session (`str` | `splusthon.sessions.abstract.Session`, `None`):
        ...
        connection (`splusthon.network.connection.common.Connection`, optional):
            The connection instance to be used when creating a new connection
            to the servers. It **must** be a type.

            Defaults to `splusthon.network.connection.tcpfull.ConnectionTcpFull`.
        ...
        app_version (`str`, optional):
            ...
            Defaults to `splusthon.version.__version__`.
    ...
    def __init__(
        ...
        if not api_id or not api_hash:
            raise ValueError(
                ...
                "Refer to splusthon.rtfd.io for more information.")
