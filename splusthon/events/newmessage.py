...
class NewMessage(EventBuilder):
    ...
    class Event(EventCommon):
        ...
        to all effects as a `Message <splusthon.tl.custom.message.Message>`,
        so please **refer to its documentation** to know what you can do
        with this event.

        Members:
            message (`Message <splusthon.tl.custom.message.Message>`):
                This is the only difference with the received
                `Message <splusthon.tl.custom.message.Message>`, and will
                return the `splusthon.tl.custom.message.Message` itself,
                not the text.

                See `Message <splusthon.tl.custom.message.Message>` for
