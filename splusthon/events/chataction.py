...
class ChatAction(EventBuilder):
    ...
    * Whenever a user is removed or leaves a group if it has
    ...
    class Event(EventCommon):
        ...
        Members:
            action_message  (`MessageAction <https://tl.splusthon.dev/types/message_action.html>`_):
        ...
        async def get_pinned_message(self):
            ...
            <splusthon.tl.custom.message.Message>` object that was pinned.
            """
        ...
        async def get_pinned_messages(self):
            ...
            <splusthon.tl.custom.message.Message>` objects that were pinned.
            """
