...
class Album(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        Members:
            messages (Sequence[`Message <splusthon.tl.custom.message.Message>`]):
        ...
        async def get_reply_message(self):
            """
            The `Message <splusthon.tl.custom.message.Message>`
        ...
        async def reply(self, *args, **kwargs):
            ...
            for `splusthon.client.messages.MessageMethods.send_message`
