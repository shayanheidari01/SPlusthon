...
class CallbackQuery(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        async def respond(self, *args, **kwargs):
            ...
            `splusthon.client.messages.MessageMethods.send_message` with
            ``entity`` already set.
        ...
        async def edit(self, *args, **kwargs):
            ...
            `splusthon.client.messages.MessageMethods.edit_message` with
            ...
            .. note::
                ...
                `Message.edit <splusthon.tl.custom.message.Message.edit>`,
