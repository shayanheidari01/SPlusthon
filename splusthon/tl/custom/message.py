...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    <splusthon.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <splusthon.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    Members:
        ...
        message (`str`):
            ...
            <splusthon.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `SoroushClient <splusthon.client.soroushclient.SoroushClient>`
    ...
    def forward(self):
        """
        The `Forward <splusthon.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <splusthon.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <splusthon.tl.custom.file.File>` wrapping the
        ...
        `file.id <splusthon.tl.custom.file.File.id>`,
        `file.name <splusthon.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from splusthon.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `splusthon.client.soroushclient.SoroushClient` instance directly.
        """
        if self._client:
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `splusthon.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `splusthon.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <splusthon.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <splusthon.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <splusthon.tl.types.PollAnswer>` argument.
