...
class MessageButton:
    ...
    .. note::
        ...
        <splusthon.tl.custom.button.Button>` instead.
    ...
    def client(self):
        """
        Returns the `splusthon.client.soroushclient.SoroushClient`
    ...
    async def click(self, share_phone=None, share_geo=None, *, password=None, open_url=None):
        ...
        sent, and the sent `Message <splusthon.tl.custom.message.Message>` returned.
