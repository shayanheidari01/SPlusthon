...
class ChatGetter(abc.ABC):
    ...
    def chat(self):
        ...
        If you're using `splusthon.events`, use `get_chat()` instead.
        """
        return self._chat
    ...
    def input_chat(self):
        ...
        <splusthon.tl.custom.sendergetter.SenderGetter.input_sender>`, this
    ...
    def is_private(self):
        ...
        (e.g. on `events.MessageDeleted <splusthon.events.messagedeleted.MessageDeleted>`).
        """
