...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <splusthon.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <splusthon.events.callbackquery.CallbackQuery>` will trigger with the
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None,
        ...
        <splusthon.events.newmessage.NewMessage>`. You cannot distinguish
