...
5. **خINT خطا را دوباره raise نکنید**: مگر اینکه بخواهید در سطح بالاتر مدیریت شود

---

## مرحله بعدی

برای یادگیری بیشتر درباره API کامل، بخش [API کامل]({% link concepts/full-api.md %}) را مطالعه کنید.
